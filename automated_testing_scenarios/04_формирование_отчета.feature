...
Сценарий: Я проверяю корректность формирования отчета "Анализ выставленных актов" от имени бухгалтера
	...
	*Открываю отчет "Анализ выставленных актов"
		...
		Тогда открылось окно "Отчеты раздела \"Обслуживание клиентов\""
		И я нажимаю на гиперссылку с именем 'Вариант_b4e3d178e2f611efb055346f24c042ba_Подсистема_b2684d3de2f611efb055346f24c042ba'
