...
## Дипломный проект профессии «1C-программист: с нуля до middle» от Нетологии


### Первоначальная настройка

Инструкция по первоначальной настройке конфигурации и запуску автоматизированного тестирования расположена [здесь](https://github.com/Dmitriy-Yeskin/Your_computer_master/blob/onec-mid-31/manual.pdf).
...
* [Конфигурация](https://github.com/Dmitriy-Yeskin/Your_computer_master/releases/download/v1.1/ycm_upd.cf "Скачать файл конфигурации")
* [Демонстрационная база](https://github.com/Dmitriy-Yeskin/Your_computer_master/releases/download/v1.1/DemoBase.dt "Скачать файл демонстрационной базы")
