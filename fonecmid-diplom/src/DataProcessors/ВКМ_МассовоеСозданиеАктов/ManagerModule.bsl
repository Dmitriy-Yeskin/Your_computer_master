...
Функция СоздатьДокументРеализацияТоваровУслуг(Выборка, Период)
	...
	РеквизитыДоговора = Новый Структура("ВидДоговора, ВКМ_СуммаАбонентскойПлаты", Выборка.ВидДоговора, Выборка.ВКМ_СуммаАбонентскойПлаты);
	НовыйДокумент.ВКМ_ВыполнитьАвтозаполнение(РеквизитыДоговора);
