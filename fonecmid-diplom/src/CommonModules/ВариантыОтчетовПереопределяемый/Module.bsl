...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	Разделы.Добавить(ВариантыОтчетовКлиентСервер.ИдентификаторНачальнойСтраницы(), НСтр("ru = 'Основные отчеты'"));
	// {{Еськин Д.Л. Доработка кода __ от 01.02.2025
	Разделы.Добавить(Метаданные.Подсистемы.ВКМ_ОбслуживаниеКлиентов);
	Разделы.Добавить(Метаданные.Подсистемы.ВКМ_РасчетУправленческойЗарплаты);
	// }}Еськин Д.Л. Доработка кода __ от 01.02.2025
КонецПроцедуры
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	//{{Еськин Д.Л. Доработка кода __ от 01.02.2025
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ВКМ_ВыработкаСпециалистов);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ВКМ_РасчетыССотрудниками);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ВКМ_АнализВыставленныхАктов);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ВКМ_РасходЗапланированныхОтпусков);
	// }}Еськин Д.Л. Доработка кода __ от 01.02.2025
КонецПроцедуры
